...
<jsp:include page="/baselayout/headerNoFixedTop.jsp"/>
	<main>
	<div class="row div1">
		<div class="col-12 text-muted bg-light text-center" style="margin-bottom: 40px;">購入手続き</div>
		...
		<div class="col-12 text-center" style="margin-top: 40px;">
			...
			<a href="BuyConfirm?totalPrice=${totalPrice}" class="btn btn-outline-success" style="margin-left: 20px;">購入</a>
		</div>
	</div>
	</main>
