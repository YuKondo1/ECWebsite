...
<jsp:include page="/baselayout/headerNoImage.jsp"/>
	<main>
	<div class="row div1">
		<div class="col-12 text-muted bg-light text-center" style="margin-top: 80px;">閲覧履歴</div>
		<c:forEach var="item" items="${itemList}">
			<div class="col-4 col-md-3 text-muted text-center" style="height: 350px; padding: 20px;">
